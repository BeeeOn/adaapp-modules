...
public:
	 ...
	 */
	virtual void extractValues(std::vector<BeeeOnSensorValue> &values,
...
protected:
	...
	{
		return (commandClass1 == commandClass2 && index1 == index2) ? true : false;
	}
	 ...
	 */
	bool extractFloat(float &value, const ZWaveSensorValue &item);
	/*
